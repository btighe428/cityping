...
export const NYC_KNOWLEDGE_BASE: KnownEvent[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    id: "asp-snow-emergency",
    title: "Snow Emergency ASP Suspension",
    shortTitle: "Snow Emergency",
    description: "ASP suspended during declared snow emergencies (triggered by 6+ inch forecasts)",
    category: "parking",
    icon: "❄️",
    recurrence: { type: "manual", dates: ["2026-01-15", "2026-02-10", "2026-12-20"] },
    alertDaysBefore: [1, 0],
    messageTemplate:
      "Snow emergency may suspend ASP. Check 311 for real-time status before moving your car.",
    actionUrl: "https://portal.311.nyc.gov/",
    source: "nyc.gov/dot",
    lastVerified: "2026-03-01",
  },
  {
    id: "metered-parking-holidays",
    title: "Metered Parking Free - Major Holidays",
    shortTitle: "Free Meters",
    description: "Parking meters are free on Sundays and major legal holidays",
    category: "parking",
    icon: "🅿️",
    recurrence: { type: "weekly", weekdays: [7] },
    alertDaysBefore: [0],
    messageTemplate:
      "Parking meters are free today (Sundays and major holidays).",
    source: "nyc.gov/dot",
    lastVerified: "2026-03-01",
  },
  {
    id: "congestion-pricing-holiday-rates",
    title: "Congestion Pricing Holiday Rates",
    shortTitle: "CRZ Holiday Rate",
    description: "Congestion pricing drops to off-peak rate on federal holidays",
    category: "parking",
    icon: "💲",
    recurrence: { type: "fixed-date", month: 12, day: 25 },
    alertDaysBefore: [3, 1, 0],
    messageTemplate:
      "Congestion pricing at off-peak rate today ($2.25 instead of $9). Holiday schedule in effect.",
    actionUrl: "https://new.mta.info/congestion-relief-zone",
    premium: true,
    source: "mta.info",
    lastVerified: "2026-03-01",
  ...
  // ---------------------------------------------------------------------------
  {
    id: "l-train-weekend-shuttles",
    title: "L Train Weekend Service Changes",
    shortTitle: "L Train Work",
    description: "L train frequently has weekend service changes for tunnel repairs",
    category: "transit",
    icon: "🚇",
    recurrence: { type: "weekly", weekdays: [6, 7] },
    alertDaysBefore: [1],
    messageTemplate:
      "Check for L train service changes this weekend. Tunnel work may affect Canarsie Tube service.",
    actionUrl: "https://new.mta.info/alerts",
    premium: true,
    source: "mta.info",
    lastVerified: "2026-03-01",
  },
  {
    id: "path-holiday-schedule-2026",
    title: "PATH Holiday Schedule",
    shortTitle: "PATH Holiday",
    description: "PATH train runs weekend/holiday schedule on federal holidays",
    category: "transit",
    icon: "🚇",
    recurrence: { type: "fixed-date", month: 12, day: 25 },
    alertDaysBefore: [3, 1, 0],
    messageTemplate:
      "PATH trains on holiday schedule today. Reduced frequency - plan extra travel time.",
    actionUrl: "https://www.panynj.gov/path/en/index.html",
    premium: true,
    source: "panynj.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "nyc-ferry-seasonal-schedule",
    title: "NYC Ferry Summer Schedule Begins",
    shortTitle: "Ferry Schedule",
    description: "NYC Ferry switches to expanded summer schedule with more frequent service",
    category: "transit",
    icon: "⛴️",
    recurrence: { type: "manual", dates: ["2026-05-25"] },
    alertDaysBefore: [14, 7, 1],
    messageTemplate:
      "NYC Ferry summer schedule starts {date}. More frequent service and extended hours.",
    actionUrl: "https://www.ferry.nyc",
    premium: true,
    source: "ferry.nyc",
    lastVerified: "2026-03-01",
  },
  {
    id: "citibike-membership-renewal",
    title: "Citi Bike Annual Membership Renewal",
    shortTitle: "Citi Bike Renewal",
    description: "Annual Citi Bike membership renewals typically in spring",
    category: "transit",
    icon: "🚲",
    recurrence: { type: "fixed-date", month: 4, day: 1 },
    alertDaysBefore: [30, 14, 7],
    messageTemplate:
      "Check your Citi Bike membership renewal date. Annual memberships auto-renew - update payment if needed.",
    actionUrl: "https://citibikenyc.com/",
    premium: true,
    source: "citibikenyc.com",
    lastVerified: "2026-03-01",
  },
  {
    id: "lirr-off-peak-changes",
    title: "LIRR Off-Peak Fare Hours",
    shortTitle: "LIRR Off-Peak",
    description: "LIRR off-peak fares apply weekdays after 10am departure from NYC",
    category: "transit",
    icon: "🚂",
    recurrence: { type: "weekly", weekdays: [1, 2, 3, 4, 5] },
    alertDaysBefore: [0],
    messageTemplate:
      "LIRR off-peak fares start at 10am departures from Penn/Atlantic. Save up to 25% by traveling later.",
    actionUrl: "https://new.mta.info/fares/lirr",
    premium: true,
    source: "mta.info",
    lastVerified: "2026-03-01",
  },
  {
    id: "governors-island-ferry-season",
    title: "Governors Island Season Opens",
    shortTitle: "Gov Island Opens",
    description: "Governors Island opens for the season with free ferry from Manhattan",
    category: "culture",
    icon: "🏝️",
    recurrence: { type: "manual", dates: ["2026-05-01"] },
    alertDaysBefore: [14, 7, 3, 1],
    messageTemplate:
      "Governors Island opens {date}! Free ferry from Manhattan before noon on weekends.",
    actionUrl: "https://www.govisland.com",
    source: "govisland.com",
    lastVerified: "2026-03-01",
  },
  ...
  // ---------------------------------------------------------------------------
  {
    id: "property-tax-exemption-renewal",
    title: "Property Tax Exemption Renewal Deadline",
    shortTitle: "Tax Exemption",
    description: "Deadline to renew property tax exemptions (STAR, senior, veterans)",
    category: "tax",
    icon: "🏠",
    recurrence: { type: "fixed-date", month: 3, day: 15 },
    alertDaysBefore: [30, 14, 7, 3, 1],
    messageTemplate:
      "Property tax exemption renewal deadline is {date}. Renew STAR, senior, or veterans exemptions at nyc.gov/finance.",
    actionUrl: "https://www.nyc.gov/site/finance/benefits/landlords-702.page",
    premium: true,
    source: "nyc.gov/finance",
    lastVerified: "2026-03-01",
  },
  {
    id: "nyc-budget-hearings-2026",
    title: "NYC City Council Budget Hearings Begin",
    shortTitle: "Budget Hearings",
    description: "Annual city budget hearings where public testimony is accepted",
    category: "civic",
    icon: "🏛️",
    recurrence: { type: "manual", dates: ["2026-03-16"] },
    alertDaysBefore: [14, 7, 3],
    messageTemplate:
      "NYC budget hearings start {date}. Public testimony accepted - have your say on city spending.",
    actionUrl: "https://council.nyc.gov/budget/",
    source: "council.nyc.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "idnyc-enrollment-events",
    title: "IDNYC Pop-Up Enrollment Events",
    shortTitle: "IDNYC Enrollment",
    description: "Free NYC municipal ID enrollment events across the city",
    category: "civic",
    icon: "🪪",
    recurrence: { type: "monthly", day: 1 },
    alertDaysBefore: [7, 3],
    messageTemplate:
      "IDNYC enrollment events happening this month. Free city ID with benefits at libraries and community centers.",
    actionUrl: "https://www.nyc.gov/site/idnyc/index.page",
    source: "nyc.gov/idnyc",
    lastVerified: "2026-03-01",
  },
  {
    id: "jury-duty-awareness",
    title: "NYC Jury Duty Service Reminder",
    shortTitle: "Jury Duty",
    description: "Periodic reminder about jury duty obligations and postponement options",
    category: "civic",
    icon: "⚖️",
    recurrence: { type: "fixed-date", month: 9, day: 1 },
    alertDaysBefore: [7],
    messageTemplate:
      "Jury duty summons? You can postpone up to 6 months online or request accommodations at nyjuror.gov.",
    actionUrl: "https://www.nyjuror.gov",
    premium: true,
    source: "nyjuror.gov",
    lastVerified: "2026-03-01",
  },
  ...
  // ---------------------------------------------------------------------------
  {
    id: "liheap-heating-assistance",
    title: "LIHEAP Heating Assistance Application Window",
    shortTitle: "LIHEAP Open",
    description: "Low Income Home Energy Assistance Program applications open",
    category: "housing",
    icon: "🔥",
    recurrence: { type: "fixed-date", month: 11, day: 1 },
    alertDaysBefore: [14, 7, 1],
    messageTemplate:
      "LIHEAP heating assistance applications open {date}. Income-eligible NYers can get help with heating costs.",
    actionUrl: "https://otda.ny.gov/programs/heap/",
    source: "otda.ny.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "lead-paint-inspection-season",
    title: "NYC Lead Paint Inspection Season",
    shortTitle: "Lead Inspections",
    description: "Landlords must conduct annual lead paint inspections in apartments with children under 6",
    category: "housing",
    icon: "🏠",
    recurrence: { type: "fixed-date", month: 8, day: 1 },
    alertDaysBefore: [14, 7],
    messageTemplate:
      "Lead paint inspection season: landlords must inspect apartments with children under 6. Report violations to 311.",
    actionUrl: "https://www.nyc.gov/site/hpd/services-and-information/lead-based-paint.page",
    premium: true,
    source: "nyc.gov/hpd",
    lastVerified: "2026-03-01",
  },
  {
    id: "dhcr-lease-renewal-window",
    title: "DHCR Rent Stabilized Lease Renewal Period",
    shortTitle: "Lease Renewal",
    description: "Landlords must offer lease renewal 150-90 days before expiration for rent-stabilized apartments",
    category: "housing",
    icon: "📄",
    recurrence: { type: "fixed-date", month: 6, day: 1 },
    alertDaysBefore: [14, 7],
    messageTemplate:
      "Rent-stabilized tenants: your landlord must offer renewal 90-150 days before lease expires. Know your rights at hcr.ny.gov.",
    actionUrl: "https://hcr.ny.gov/tenant-rights",
    premium: true,
    source: "hcr.ny.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "nycha-waiting-list-2026",
    title: "NYCHA Waiting List Application Window",
    shortTitle: "NYCHA Wait List",
    description: "NYCHA occasionally opens its waiting list for public housing applications",
    category: "housing",
    icon: "🏢",
    recurrence: { type: "manual", dates: ["2026-04-01"] },
    alertDaysBefore: [30, 14, 7, 3],
    messageTemplate:
      "NYCHA waiting list may open {date}. Check nyc.gov/nycha for application availability.",
    actionUrl: "https://www.nyc.gov/site/nycha/residents/applying-for-housing.page",
    source: "nyc.gov/nycha",
    lastVerified: "2026-03-01",
  },

  // ---------------------------------------------------------------------------
  // SAFETY / WEATHER - ADDITIONAL
  // ---------------------------------------------------------------------------
  {
    id: "winter-storm-season-start",
    title: "Winter Storm Season Begins",
    shortTitle: "Storm Season",
    description: "Peak nor'easter and winter storm season for NYC",
    category: "weather",
    icon: "🌨️",
    recurrence: { type: "fixed-date", month: 12, day: 1 },
    alertDaysBefore: [7],
    messageTemplate:
      "Winter storm season starts {date}. Stock up on essentials and sign up for NotifyNYC alerts.",
    actionUrl: "https://www.nyc.gov/site/em/ready/notify-nyc.page",
    source: "noaa.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "severe-weather-awareness-week",
    title: "Severe Weather Awareness Week",
    shortTitle: "Weather Week",
    description: "NYS Severe Weather Awareness Week with safety drills",
    category: "weather",
    icon: "⛈️",
    recurrence: { type: "manual", dates: ["2026-03-02"] },
    alertDaysBefore: [7, 3],
    messageTemplate:
      "Severe Weather Awareness Week starts {date}. Review emergency plans and sign up for alerts.",
    actionUrl: "https://www.weather.gov/okx/",
    source: "weather.gov",
    lastVerified: "2026-03-01",
  },
  {
    id: "mosquito-spraying-season",
    title: "NYC Mosquito Spraying Season Begins",
    shortTitle: "Mosquito Spray",
    description: "NYC Health Dept begins mosquito control spraying operations",
    category: "safety",
    icon: "🦟",
    recurrence: { type: "fixed-date", month: 6, day: 1 },
    alertDaysBefore: [7],
    messageTemplate:
      "Mosquito spraying season starts {date}. Check spray schedules and protect against West Nile at nyc.gov/health.",
    actionUrl: "https://www.nyc.gov/site/doh/health/health-topics/west-nile-virus.page",
    source: "nyc.gov/health",
    lastVerified: "2026-03-01",
  },
  {
    id: "con-edison-summer-peak",
    title: "Con Edison Summer Peak Season",
    shortTitle: "Peak Electric",
    description: "Con Edison summer peak pricing and conservation alerts begin",
    category: "safety",
    icon: "⚡",
    recurrence: { type: "fixed-date", month: 6, day: 1 },
    alertDaysBefore: [7],
    messageTemplate:
      "Con Edison summer peak season starts {date}. Electricity rates increase - conserve during 2-6pm to save.",
    actionUrl: "https://www.coned.com/en/save-money",
    premium: true,
    source: "coned.com",
    lastVerified: "2026-03-01",
  },
  {
    id: "fireworks-safety-july",
    title: "Fireworks Safety Alert",
    shortTitle: "Fireworks Safety",
    description: "Reminder that consumer fireworks are illegal in NYC",
    category: "safety",
    icon: "🧨",
    recurrence: { type: "fixed-date", month: 7, day: 1 },
    alertDaysBefore: [3, 1],
    messageTemplate:
      "Reminder: Consumer fireworks are ILLEGAL in NYC. Report illegal fireworks to 311. Attend Macy's display instead!",
    source: "nyc.gov/fdny",
    lastVerified: "2026-03-01",
  },
  {
    id: "tick-season-start",
    title: "Tick Season Begins",
    shortTitle: "Tick Season",
    description: "Peak tick activity season - take precautions in parks and wooded areas",
    category: "safety",
    icon: "🕷️",
    recurrence: { type: "fixed-date", month: 5, day: 1 },
    alertDaysBefore: [7],
    messageTemplate:
      "Tick season starts {date}. Use repellent and check for ticks after visiting parks, especially Staten Island and the Bronx.",
    actionUrl: "https://www.nyc.gov/site/doh/health/health-topics/ticks.page",
    source: "nyc.gov/health",
    lastVerified: "2026-03-01",
  },
